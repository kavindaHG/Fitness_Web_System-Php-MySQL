      ...
      <div class="row">
        <div class="col-md-6 offset-md-3 ">
          <div class="signup-form">
            <form method="post" action="Controllers/clientController.php?action=add" class= "mt-2 border p-4 bg-light shadow">  
              <div class="row">
              ...
              <div class="row">
                <div class="mb-2 col-md-6">
                  <label for="" class="label control-label">Gender</label>
                ...
                <div class="mb-2 col-md-6">
                  <label for="" class="label control-label">Country</label>
                  <select name="contry" class="form-control" id="contry">
                  ...
                  <div class="mb-2 col-md-12">
                    <label for="" class="label control-label">Select a Photo</label>
                    <input type="file" name="img" id="img" placeholder="Email Address" class="form-control">
                </div>
                <div class="mb-2 col-md-12">
            ...
            <p class="mt-2 col-12 text-center" style="font-size:1.2rem;">If You Have an Account, Please Sign In <a href="Login.php">Sign In</a></p>
        </div>
      </div>
  </div>
