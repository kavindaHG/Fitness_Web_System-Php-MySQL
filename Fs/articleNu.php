...
<div class="row row-cols-1 row-cols-md-3 g-4">
  <div class="col">
    <div class="card mt-5 ms-5">
      <img src="images/n1.jpg" class="card-img-top img-fluid" alt="..." style="max-height:25rem; min-height:17.5rem;">
        <div class="card-body">
          <h5 class="card-title " style="font-family:poppins; color:black; font-weight:bold; font-size:1.5rem">Chicken</h5>
