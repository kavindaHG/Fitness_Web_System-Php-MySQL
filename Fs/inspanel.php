...
<html lang="en">
  ...
  <body>
    ...
    <a href="joinus.php"><div class="card mb-3 mt-5 ms-5 " style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      <img src="images/ins.jpg" class="img-fluid rounded-start" alt="...">
    </div>
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title" style="font-size:2rem; color:black; font-family:poppins">Josh Jua</h5>
        <h6 class="card-title" style="font-size:1rem; color:black; font-family:poppins">Qualifications</h6>
        <h6 class="card-title" style="font-size:1rem; color:black; font-family:poppins">Country</h6>
      </div>
    </div>
  </div>
</div>
